# csn-danhgiabaitapbangaiagent-dtm-new-1
...
```bash
git clone https://github.com/organization-codeflow/csn-danhgiabaitapbangaiagent-dtm-new-1.git
cd csn-danhgiabaitapbangaiagent-dtm-new-1
```
...
- Truy cập: https://sonarcloud.io/project/overview?id=csn-danhgiabaitapbangaiagent-dtm-new-1
- Xem các metrics:
